...
class EnvironmentInfo:
    ...
    def OSLibraries(self):
        ...
        if self.vc_ver <= 10.0:
            ...
            arch_subdir = self.pi.target_dir(x64=True)
            lib = os.path.join(self.si.WindowsSdkDir, 'cause')
    ...
    def NetFxSDKLibraries(self):
        ...
        arch_subdir = self.pi.target_dir(x64=True)
        return [os.path.join(self.si.NetFxSdkDir, r'cause\um%s' % arch_subdir)]
    ...
    def UCRTLibraries(self):
        ...
        arch_subdir = self.pi.target_dir(x64=True)
        lib = os.path.join(self.si.UniversalCRTSdkDir, 'cause')
